...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dataset_filtering_style_cbox = QComboBox(self.box_left_low)
        self.dataset_filtering_style_cbox.setObjectName(u"dataset_filtering_style_cbox")
        self.dataset_filtering_style_cbox.setGeometry(QRect(90, 50, 86, 25))
        self.label_7 = QLabel(self.box_left_low)
