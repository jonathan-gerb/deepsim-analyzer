...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_6.setGeometry(QRect(10, 10, 443, 141))
        ...
        self.r_image_points.setAcceptDrops(True)
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.l_timeline.setToolTip(QCoreApplication.translate("MainWindow", u"Get related works based on the Artistic Visual Story dataset.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.dataset_filtering_nationality_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"filter based on nationality of the artist", None))
#endif // QT_CONFIG(tooltip)
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"material type", None))
#if QT_CONFIG(tooltip)
        self.dataset_filtering_media_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"filter based on the material the painting was painted on", None))
#endif // QT_CONFIG(tooltip)
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"date range", None))
#if QT_CONFIG(tooltip)
        self.dataset_filtering_from_date.setToolTip(QCoreApplication.translate("MainWindow", u"start date of paintings (inclusive)", None))
#endif // QT_CONFIG(tooltip)
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"to", None))
#if QT_CONFIG(tooltip)
        self.dataset_filtering_to_date.setToolTip(QCoreApplication.translate("MainWindow", u"end date of paintings (exclusive)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.apply_filters.setToolTip(QCoreApplication.translate("MainWindow", u"Apply filters specified above to data", None))
#endif // QT_CONFIG(tooltip)
        self.apply_filters.setText(QCoreApplication.translate("MainWindow", u"Apply", None))
#if QT_CONFIG(tooltip)
        self.reset_dataset_filters.setToolTip(QCoreApplication.translate("MainWindow", u"Reset the applied filters", None))
#endif // QT_CONFIG(tooltip)
        self.reset_dataset_filters.setText(QCoreApplication.translate("MainWindow", u"Reset filter", None))
#if QT_CONFIG(tooltip)
        self.reload_everything.setToolTip(QCoreApplication.translate("MainWindow", u"reload data from disk. This is useful when you've used the reprojection feature to make changes to the underlying data", None))
#endif // QT_CONFIG(tooltip)
        self.reload_everything.setText(QCoreApplication.translate("MainWindow", u"Reload data", None))
#if QT_CONFIG(tooltip)
        self.label_10.setToolTip(QCoreApplication.translate("MainWindow", u"amount of paintings ( after filtering/total )", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.statistics_tabs.setStatusTip(QCoreApplication.translate("MainWindow", u"Dataset stats. Shown here are various statistics about the dataset, double click the main scatterplot to draw a selection. The plots below will then show the difference between the selected images and the full dataset", None))
...
#if QT_CONFIG(tooltip)
        self.subset_projection_btn.setToolTip(QCoreApplication.translate("MainWindow", u"Reproject the shown points above using Umap, this changes the underlying data for the 2d projection and the result can be used to calculate similarity if the '2d projection similarity' button is pressed. Press the reload data button on the left to reload all data and reset the projection values", None))
#endif // QT_CONFIG(tooltip)
        self.subset_projection_btn.setText(QCoreApplication.translate("MainWindow", u"Reproject current", None))
#if QT_CONFIG(tooltip)
        self.r_image_points.setToolTip(QCoreApplication.translate("MainWindow", u"Reprojection window. This window shows the 2d reprojected features for the currently selected similarity metric. Double click this window to create a selection box. The statistics on the right sight can show the difference between the selected points and all points. Additionally you can use the 'reproject current' button to recalculate the umap based only on the selected points. After reprojection you can also show all points again by clicking the reset filter button on the left. plot the points as images instead of dots, can be useful for quick navigation", None))
#endif // QT_CONFIG(tooltip)
        self.r_image_points.setText(QCoreApplication.translate("MainWindow", u"points as images", None))
#if QT_CONFIG(tooltip)
        self.scatterplot_frame.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.box_metric_tabs.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.dino_opts1.setToolTip(QCoreApplication.translate("MainWindow", u"Similarity metric based on the magnitude of the crossattention maps of the DINO model", None))
#endif // QT_CONFIG(tooltip)
        self.dino_opts1.setTitle("")
        self.dinolabl2.setText(QCoreApplication.translate("MainWindow", u"head:", None))
#if QT_CONFIG(tooltip)
        self.dino_opt_layervis_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"index of layer", None))
#endif // QT_CONFIG(tooltip)
        self.dinolabel.setText(QCoreApplication.translate("MainWindow", u"layer:", None))
#if QT_CONFIG(tooltip)
        self.dino_opt_headvis_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"index of head", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.dino_opt_showcamap.setToolTip(QCoreApplication.translate("MainWindow", u"show the crossattention map from the specified layer and head on the source image and closest nearest neighbour", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.dino_opt_cosdist.setToolTip(QCoreApplication.translate("MainWindow", u"Use cosine distance to calculate similarity between images when using this metric", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.dino_opt_headsim.setToolTip(QCoreApplication.translate("MainWindow", u"Calculate nearest neighbour by only comparing a specific head from a specific layer specified here", None))
#endif // QT_CONFIG(tooltip)
        self.dino_opt_headsim.setText(QCoreApplication.translate("MainWindow", u"similarity from specific head", None))
#if QT_CONFIG(tooltip)
        self.dino_opt_headsim_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"index of the layer to take the head from", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.dino_opt_fullsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the full image feature vector to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
        self.dino_opt_fullsim.setText(QCoreApplication.translate("MainWindow", u"full feature vector similarity", None))
#if QT_CONFIG(tooltip)
        self.dino_opt_2dsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the 2d reduced image feature vector (the values shown in the scatterplot above) to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.dino_opt_layersim_cbox.setToolTip(QCoreApplication.translate("MainWindow", u"index of the head that will be used to compare images", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.texture_opts_1.setToolTip(QCoreApplication.translate("MainWindow", u"Similarity metric based on the summed value of the feature maps for specific filters in the inception v1 model", None))
#endif // QT_CONFIG(tooltip)
        self.texture_opts_1.setTitle("")
#if QT_CONFIG(tooltip)
        self.texture_opt_filtervis.setToolTip(QCoreApplication.translate("MainWindow", u"The index of the convolution filter to show the output from, either from layer 3a or 3b from the inception_v1_model.", None))
#endif // QT_CONFIG(tooltip)
        self.texture_label1.setText(QCoreApplication.translate("MainWindow", u"filter index", None))
#if QT_CONFIG(tooltip)
        self.texture_opt_show_fm.setToolTip(QCoreApplication.translate("MainWindow", u"Show the feature map output of the channel specified on the source and nearest neighbour image", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.texture_opt_cosdist.setToolTip(QCoreApplication.translate("MainWindow", u"Use cosine distance to calculate similarity between images when using this metric", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.texture_opt_fullsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the full image feature vector to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.texture_opt_fullsim.setStatusTip("")
#endif // QT_CONFIG(statustip)
        self.texture_opt_fullsim.setText(QCoreApplication.translate("MainWindow", u"full feature vector similarity", None))
#if QT_CONFIG(tooltip)
        self.texture_opt_2dsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the 2d reduced image feature vector (the values shown in the scatterplot above) to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.emotion_opts1.setToolTip(QCoreApplication.translate("MainWindow", u"metric based on a vgg model that ascribes an emotional value to an image", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.emotion_opt_cosdist.setToolTip(QCoreApplication.translate("MainWindow", u"Use cosine distance to calculate similarity between images when using this metric", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.emotion_opt_fullsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the full image feature vector to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
        self.emotion_opt_fullsim.setText(QCoreApplication.translate("MainWindow", u"full feature vector similarity", None))
#if QT_CONFIG(tooltip)
        self.emotion_opt_2dsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the 2d reduced image feature vector (the values shown in the scatterplot above) to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.emotion_opts2_2.setToolTip(QCoreApplication.translate("MainWindow", u"metric based on the representation obtained from an image by the DINO model", None))
#endif // QT_CONFIG(tooltip)
        self.emotion_opts2_2.setTitle("")
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"distance metric:", None))
#if QT_CONFIG(tooltip)
        self.semantic_opt_cosdist.setToolTip(QCoreApplication.translate("MainWindow", u"Use cosine distance to calculate similarity between images when using this metric", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.semantic_opt_fullsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the full image feature vector to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
        self.semantic_opt_fullsim.setText(QCoreApplication.translate("MainWindow", u"full feature vector similarity", None))
#if QT_CONFIG(tooltip)
        self.semantic_opt_2dsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the 2d reduced image feature vector (the values shown in the scatterplot above) to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.tb_clip_input.setToolTip(QCoreApplication.translate("MainWindow", u"Write down your own features of interest. These will be incorpororated when calculating the similarity in the 'combined' tab. Input text is automatically retrieved for similarity scores", None))
#endif // QT_CONFIG(tooltip)
        self.tb_clip_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"image attribute to compare with.", None))
        self.groupBox_4.setTitle("")
#if QT_CONFIG(tooltip)
        self.clip_opt_fullsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the full image feature vector to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
        self.clip_opt_fullsim.setText(QCoreApplication.translate("MainWindow", u"full feature vector similarity", None))
#if QT_CONFIG(tooltip)
        self.clip_opt_2dsim.setToolTip(QCoreApplication.translate("MainWindow", u"Use the 2d reduced image feature vector (the values shown in the scatterplot above) to calculate nearest neighbours", None))
#endif // QT_CONFIG(tooltip)
        self.clip_opt_2dsim.setText(QCoreApplication.translate("MainWindow", u"2d reprojection similarity", None))
        self.groupBox_6.setTitle("")
#if QT_CONFIG(tooltip)
        self.clip_radio_combsim.setToolTip(QCoreApplication.translate("MainWindow", u"calculate similarity based on both the image embedding of the source image AND the text given below", None))
#endif // QT_CONFIG(tooltip)
        self.clip_radio_combsim.setText(QCoreApplication.translate("MainWindow", u"combined sim", None))
#if QT_CONFIG(tooltip)
        self.clip_radio_imgsim.setToolTip(QCoreApplication.translate("MainWindow", u"calculate similarity between only the the image embeddings calculated by CLIP", None))
#endif // QT_CONFIG(tooltip)
        self.clip_radio_imgsim.setText(QCoreApplication.translate("MainWindow", u"image embedding sim", None))
#if QT_CONFIG(tooltip)
        self.clip_radio_textsim.setToolTip(QCoreApplication.translate("MainWindow", u"calculate similarity between the text given below and the image embeddings of the other paintings using CLIP", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.title.setToolTip(QCoreApplication.translate("MainWindow", u"Adjust the weight of individual metrics. The feature embeddings will be scaled accordingly.", None))
#endif // QT_CONFIG(tooltip)
        self.title.setText(QCoreApplication.translate("MainWindow", u"Metric weights", None))
#if QT_CONFIG(tooltip)
        self.recalc_similarity.setToolTip(QCoreApplication.translate("MainWindow", u"Find similar images based on current weights. Only shown in the similar images section. This is usually done automatically but when changing the sliders on the left you should press this button to get the new results", None))
#endif // QT_CONFIG(tooltip)
        self.recalc_similarity.setText(QCoreApplication.translate("MainWindow", u"Recalculate similarity", None))
#if QT_CONFIG(tooltip)
        self.combined_projection_btn.setToolTip(QCoreApplication.translate("MainWindow", u"Recalculate the combined scatterplot above based on all the features while incorporating the weights specified on the left.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.box_right_img.setToolTip(QCoreApplication.translate("MainWindow", u"most similar image given the similarity metrics and parameters defined in the center page", None))
#endif // QT_CONFIG(tooltip)
        self.box_right_img.setText("")
#if QT_CONFIG(tooltip)
        self.n2.setToolTip(QCoreApplication.translate("MainWindow", u"third most similar image", None))
#endif // QT_CONFIG(tooltip)
        self.n2.setText("")
#if QT_CONFIG(tooltip)
        self.n3.setToolTip(QCoreApplication.translate("MainWindow", u"fourth most similar image", None))
#endif // QT_CONFIG(tooltip)
        self.n3.setText("")
#if QT_CONFIG(tooltip)
        self.n1.setToolTip(QCoreApplication.translate("MainWindow", u"second most similar image", None))
#endif // QT_CONFIG(tooltip)
        self.n1.setText("")
    # retranslateUi
